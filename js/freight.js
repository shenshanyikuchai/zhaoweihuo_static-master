window.onload = function ()
{
              ...
              { if (this.value == "") 
                {
                  ...
                  hint.innerHTML = "输入不能为空";
                }
                else if (/\D/.test(this.value)) 
                {
                  hint.style.display = "block";
                  hint.innerHTML = "时间与计价必须输入正整数";
    ...
    function judge() 
    {
      ...
      // for (var i = 0; i < heavy.length; i++) 
      // {
        if(((typeof heavy.value) == (NaN)) 
          ||((typeof bulk.value) == (NaN)))
        {
           boor = false;
        }
      // }          
    ...
    for (var i = 0; i < bulk.length; i++) 
    {
      ...
      // console.log(typeof bulk[i].value);

      if((typeof heavy[i].value)==(NaN))
      {
        btn.onclick = function () 
        {
          return false;
  ...
  {  
    ...
    if (judge()) 
    {
     ...
     // 判断填写信息 是否完整
     if(t1.value == "" || t2.value == ""||(t3.value == "" || t4.value == ""|| t5.value == ""|| t6.value == "")&&( t7.value == ""||t8.value==""||t9.value==""||t10.value==""))
     { 
     	// var  = ul_.children[0].children[3];

     	// console.log(hint);

     	hint.style.display = "block";
     	hint.innerHTML = "请把信息填写完整";	
